...
class UI:
    ...
    def display(self, player):
        self.show_bar(player.health, player.stats.get('health'), self.health_bar_rect, HEALTH_COLOR)
        self.show_bar(player.energy, player.stats.get('energy'), self.energy_bar_rect, ENERGY_COLOR)
